...
fn main() {
...

    {
        ...
        println!("[{}, {}, {}, {}], [[{}, {}, {}, {}],[{}, {}, {}, {}]], [{}, {}, {}, {}], [{}, {}, {}, {}, {}, {}, {}]",
                 ...
                 to_string(rk.get_u()), to_string(rk.get_v()),
                 to_string(jubjub::ExtendedPoint::from(value_commitment.commitment()).to_affine().get_u()),
                 to_string(jubjub::ExtendedPoint::from(value_commitment.commitment()).to_affine().get_v()),
                 to_string(cur), to_string(expected_nf[0]), to_string(expected_nf[1]),
        );
    }
}
