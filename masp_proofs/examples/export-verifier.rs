...
fn main() {
    ...
    println!(
        "uint256 constant q0 = 45442060874369865957053122457065728162598490762543039060009208264153100167851;"
    );
    ...
    println!("uint256 constant betax10 = {};", lo_string(beta_g2_x_c1));
    println!("uint256 constant betax11 = {};", hi_string(beta_g2_x_c1));
    println!("uint256 constant betax20 = {};", lo_string(beta_g2_x_c0));
    println!("uint256 constant betax21 = {};", hi_string(beta_g2_x_c0));
    println!("uint256 constant betay10 = {};", lo_string(beta_g2_y_c1));
    println!("uint256 constant betay11 = {};", hi_string(beta_g2_y_c1));
    println!("uint256 constant betay20 = {};", lo_string(beta_g2_y_c0));
    println!("uint256 constant betay21 = {};", hi_string(beta_g2_y_c0));
    println!("uint256 constant gammax10 = {};", lo_string(gamma_g2_x_c1));
    println!("uint256 constant gammax11 = {};", hi_string(gamma_g2_x_c1));
    println!("uint256 constant gammax20 = {};", lo_string(gamma_g2_x_c0));
    println!("uint256 constant gammax21 = {};", hi_string(gamma_g2_x_c0));
    println!("uint256 constant gammay10 = {};", lo_string(gamma_g2_y_c1));
    println!("uint256 constant gammay11 = {};", hi_string(gamma_g2_y_c1));
    println!("uint256 constant gammay20 = {};", lo_string(gamma_g2_y_c0));
    println!("uint256 constant gammay21 = {};", hi_string(gamma_g2_y_c0));
    println!("uint256 constant deltax10 = {};", lo_string(delta_g2_x_c1));
    println!("uint256 constant deltax11 = {};", hi_string(delta_g2_x_c1));
    println!("uint256 constant deltax20 = {};", lo_string(delta_g2_x_c0));
    println!("uint256 constant deltax21 = {};", hi_string(delta_g2_x_c0));
    println!("uint256 constant deltay10 = {};", lo_string(delta_g2_y_c1));
    println!("uint256 constant deltay11 = {};", hi_string(delta_g2_y_c1));
    println!("uint256 constant deltay20 = {};", lo_string(delta_g2_y_c0));
    println!("uint256 constant deltay21 = {};", hi_string(delta_g2_y_c0));
    ...
    println!(
        "function verifyProof(uint[4] calldata _pA, uint[4][2] calldata _pB, uint[4] calldata _pC, uint[{}] calldata _pubSignals) public view returns (bool)",
        params.vk.ic.len() - 1
    );
    println!("// Compute the linear combination vk_x");
    for i in 0..params.vk.ic.len() - 1 {
        println!(
            "g1_mulAccC(_pVk, IC{}x0, IC{}x1, IC{}y0, IC{}y1, calldataload(add(pubSignals, {})))",
            i + 1,
            i + 1,
            i + 1,
            i + 1,
