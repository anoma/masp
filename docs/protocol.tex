...
\begin{itemize}
  ...
  \item \masp{Compute $\NoteAddressRand{} = \cmOld{}
                                    = \NoteCommitSapling{\NoteCommitRand}(\reprJ\Of{\DiversifiedTransmitBase},
                                                                          \reprJ\Of{\DiversifiedTransmitPublic},
                                                                          \vOld{},
                                                                           \GroupJHash{\URS}\Of{\ascii{MASP\_\_r\_},\ascii{r}})$.}
...
\masp{$\cvOld{} = \scalarmult{\ValueNew{} \ParamJ{h} }{\NoteValueBase} + \scalarmult{\ValueCommitRandNew{}}{ \GroupJHash{\URS}\Of{\ascii{MASP\_\_r\_},\ascii{r}}} $}
...
\lsubsection{In-pool asset conversion and minting}

In some cases, it may be desirable to purposefully violate the non-exchangeability and non-forgeability property. 
In particular, certain asset types may be exchanged at fixed public rates, 
and new amounts of certain assets can be minted under certain conditions. 

Consider the example where holders of asset A should receive 1 unit of 
